...
function draw () {
  ...
  recursive_square(1*    width / 8, 3.3* height / 4, 45)
  recursive_square(1.5*  width / 8, 3.4* height / 4, 35)
  recursive_square(2*    width / 8, 3.6* height / 4, 26)
  recursive_square(2.5*  width / 8, 3.4* height / 4, 28)
  recursive_square(3*    width / 8, 3.6* height / 4, 23)
  recursive_square(3.5*  width / 8, 3.5* height / 4, 30)
  recursive_square(4*    width / 8, 3.6* height / 4, 27)
  recursive_square(4.5*  width / 8, 3.7* height / 4, 18)
  recursive_square(5*    width / 8, 3.5* height / 4, 24)
  recursive_square(5.5*  width / 8, 3.4* height / 4, 25)
  recursive_square(6*    width / 8, 3.35* height / 4, 35)
  recursive_square(6.5*  width / 8, 3.6* height / 4, 37)
  recursive_square(7*    width / 8, 3.3* height / 4, 43)
}
